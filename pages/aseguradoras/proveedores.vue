...
//   })
// }
const { proveedores } = useAseguradora()
</script>
<template>
  <NuxtLayout name="aseguradoras-dashboard">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <NuxtLink href="/aseguradoras/inicio" class="text-muted">Inicio</NuxtLink>
        </li>
        <li class="breadcrumb-item active fw-semibold" aria-current="page">Proveedores</li>
      </ol>
    </nav>
    <p>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <span>Mostrando <span class="fw-semibold">10 proveedores</span></span>
      <div class="d-flex">
        ...
        <div class="dropdown">
          <button class="btn btn-outline-dark dropdown-toggle fw-light bg-white" type="button" data-bs-toggle="dropdown"
            aria-expanded="false">
            Ordenar por
          </button>
    ...
    <div class="row">
      <div class="col">
        <div class="card shadow border-0 rounded-4 mb-4" v-for="clinica in proveedores">
              ...
              <div class="col d-flex flex-column justify-content-between">
                <div>
                  ...
                  <div class="d-flex my-3" v-if="clinica.service_name">
                    <span class="badge rounded-circle bg-success text-success me-2"
                      v-for="service in clinica.service_name" style="--bs-bg-opacity: 0.1">{{ service.name }}</span>
                    <!-- <p
      ...
      <div class="col">
        <div class="card bg-dark-subtle d-flex align-items-center justify-content-center rounded-5"
