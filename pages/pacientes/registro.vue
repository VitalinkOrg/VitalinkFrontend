  ...
  <NuxtLayout name="pacientes-login">
    ...
    <form>
      <div class="form-group mb-4">
        ...
        <input type="text" class="form-control" id="nombre" aria-describedby="nombreHelp" placeholder="Escribe tu nombre">
        <!-- <div id="nombreHelp" class="form-text">We'll never share your email with anyone else.</div> -->
      </div>
      <div class="form-group mb-4">
        <label for="email" class="form-label text-capitalize">Tu correo electrónico o número de teléfono</label>
      ...
      <div class=" form-check">
        ...
        <label class="form-check-label fw-light" for="recordarme"><small>Recordarme</small></label>
      </div>
      <div class=" form-check">
        <input type="checkbox" class="form-check-input border-dark" id="condiciones">
        <label class="form-check-label fw-light" for="condiciones"><small>He leído y acepto la Política de
            Privacidad y
            condiciones
            de uso</small></label>
      </div>
      ...
      <div class="text-center py-3">
        <NuxtLink class="btn-link" href="/pacientes/login">Ya tienes una cuenta?</NuxtLink>
      </div>
    </form>
    <hr>
