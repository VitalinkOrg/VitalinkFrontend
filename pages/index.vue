              ...
              <div class="card rounded-4 border-0 shadow text-center">
                <div class="card-body">
                  ...
                  <p class="text-muted">
                    ...
                    profesionales que se especializan en la cirugía que
                    necesitas.
                  </p>
                </div>
              </div>
              ...
              <div class="card rounded-4 border-0 shadow text-center">
                <div class="card-body">
                  ...
                  <p class="text-muted">
                    ...
                    tus necesidades quirúrgicas con precisión y facilidad.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card rounded-4 border-0 shadow text-center">
                <div class="card-body">
                  ...
                  <p class="text-muted">
                    ...
                    adecuados, programa citas sin esfuerzo a través de nuestra
                    plataforma.
                  </p>
                </div>
              </div>
            ...
            <div class="row align-items-center">
              <div class="col-sm-6 ps-5">
                <h2 class="h2 text-white">
                  <strong>Quienes confían en nosotros</strong>
                </h2>
                <p class="text-white">
                  Estos Centros Médicos forman parte de nuestro directorio de
            ...
            <div class="row">
              ...
              >
                <div class="py-4 ps-3">
                  ...
                  <p class="text-light">
                    Estas preguntas frecuentes están diseñadas para proporcionar respuestas claras y útiles a los usuarios de VitaLink. Si tienes preguntas adicionales, no dudes en ponerte en contacto con nuestro equipo de soporte.
                  </p>
