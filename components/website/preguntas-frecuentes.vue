...
const faqItems = ref<FaqItem[]>([
  {
    id: 1,
    question: "¿Qué es Vitalink y cómo me ayuda?",
    answer: [
      "Vitalink es una plataforma digital que conecta a pacientes con profesionales de la salud altamente calificados, donde podés buscar y comparar especialistas, agendar tu cita de valoración y reservar procedimientos médicos de forma segura y transparente.",
      "Con Vitalink también tenés acceso a opciones de financiamiento a través de entidades organizadas reguladas, sin desembolsos al paciente y con cuotas claras. \n Nuestro compromiso es que pagues lo justo, sin membresías ni costos ocultos, siempre con precios respaldados en una proforma detallada. Además, te acompañamos durante todo el proceso: desde la valoración inicial hasta tu procedimiento, garantizando una experiencia confiable y sin sorpresas.",
    ],
    isOpen: true,
  },
  {
