      ...
      <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
         <div class="modal-content">
            ...
            <div class="modal-footer" v-if="reserva[0].step === 1">
               ...
               <div class="col">
                  <button type="button" class="btn btn-primary w-100 btn-lg" @click="reserva[0].step = 2">Comenzar</button>
               </div>
            </div>
                     ...
                     <div class="col">
                        <div class="bg-primary rounded-4 h-100 p-4" style="--bs-bg-opacity: 0.04">
                           <div class="form-group mb-3">
                              ...
                              <input type="text" placeholder="Escribe tu nombre" class="form-control shadow-sm "
                                 id="nombre" name="nombre">
                           </div>
                           <div class="form-group mb-3">
                              <label for="apellidos" class="form-label">Apellidos (s)</label>
                              <input type="text" placeholder="Escribe tu apellido" class="form-control shadow-sm "
                                 id="apellidos" name="apellidos">
                           </div>
                           <div class="form-group mb-3">
                              <label for="telefono" class="form-label">Número de teléfono</label>
                              <input type="phone" placeholder="+1(555) 000-0000" class="form-control shadow-sm "
                           ...
                           <div class="row row-cols-sm-3 mb-5">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" placeholder="Ciudad" class="form-control shadow-sm " required
            ...
            <div class="modal-footer" v-if="reserva[0].step === 2">
               ...
               <div class="col">
                  <button type="button" class="btn btn-primary w-100 btn-lg"
                     @click="reserva[0].step = 3">Siguiente</button>
               </div>
            </div>
                     ...
                     <div class="col">
                        ...
                        name="nombre"> -->
                           ...
                           <div class="form-group mb-3">
                              ...
                              <input type="text" placeholder="Escribe el número de tu matrícula"
                                 class="form-control shadow-sm " id="numero-matricula" name="numero-matricula">
                           </div>
            ...
            <div class="modal-footer" v-if="reserva[0].step === 3">
               ...
               <div class="col">
                  <button type="button" class="btn btn-primary w-100 btn-lg"
                     @click="reserva[0].step = 4">Siguiente</button>
               </div>
            </div>
                        ...
                        <div class="bg-primary rounded-4 h-100 p-4" style="--bs-bg-opacity: 0.04">
                           ...
                           <div class="bg-primary rounded-4 p-3 mb-3" style="--bs-bg-opacity: 0.1">
                              <div class="form-group mb-4">
                                 ...
                                 <input type="text" class="form-control" placeholder="Escribe el nombre del hospital"
                              ...
                              <div class="row row-cols-2">
                                 <div class="form-group mb-4">
                                    ...
                                    <input type="phone" class="form-control" placeholder="0000-0000" name="telefono"
                                       required />
                                    <!-- <div id="nombreHelp" class="form-text">We'll never share your email with anyone else.</div> -->
                                 </div>
                                 <div class="form-group mb-4">
                                    <label for="direccion" class="form-label text-capitalize">Dirección</label>
                                    <input type="text" class="form-control" placeholder="Escribe la dirección"
                              ...
                              <div class="row row-cols-2">
                                 <div class="form-group mb-4">
                                    ...
                                    <input type="password" class="form-control" id="password"
                                       placeholder="Escribe tu contraseña" aria-describedby="passwordHelp" required
                                       name="password" />
            ...
            <div class="modal-footer" v-if="reserva[0].step === 4">
               ...
               <div class="col">
                  <button type="button" class="btn btn-primary w-100 btn-lg"
                     @click="reserva[0].step = 5">Siguiente</button>
               </div>
            </div>
            ...
            <span v-if="reserva[0].step === 5">
              ...
              <div class="col">
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-primary w-100 btn-lg"
                     @click="reserva[0].open = false">Siguiente</button>
               </div>
            </span>
