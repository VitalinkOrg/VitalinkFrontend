import type { IServicioClinica } from "~/types/test-index";
  ...
  const servicios = useState<IServicioClinica[]>("servicios", () => [
    {
      ...
      descripcion:
        "La cirugía de cataratas es un procedimiento oftalmológico comúnmente realizado para restaurar la visión nublada debido a la opacificación del cristalino del ojo. ",
      amenidades: [
