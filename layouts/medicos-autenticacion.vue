<template>
  ...
  <main class="layout-main">
    <section
      class="left text-center layout-main__left layout-main__left--hidden-sm"
    >
      <NuxtLink class="layout-main__logo" href="/"
        ><img src="@/src/assets/img-vitalink-logo.svg" alt="Vitalink Logo"
      /></NuxtLink>
      <img src="@/src/assets/img-doctor-login.png" alt="Doctor Login" />
...
.layout-main {
  ...
  & .layout-main__logo img {
    width: 10rem;
  }

  & .layout-main__description {
    font-size: 1rem;
    font-weight: 400;
