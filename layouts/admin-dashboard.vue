  ...
  <div class="dashboard bg-light">
    <div class="dashboard-sidebar bg-white shadow py-4 px-2">
      <nav class="nav d-flex flex-column align-items-start w-100">
        ...
        <li class="nav-item w-100 mb-3">
          <button
            class="nav-link rounded-3 py-3 text-dark d-flex align-items-center w-100 bg-transparent border-0 text-start"
            @click="isBillingCollapsed = !isBillingCollapsed"
          >
            <span class="text-primary me-3">
              <AtomsIconsDollarIcon />
            </span>
            Pagos y Facturación
            <span class="ms-auto">
              <AtomsIconsChevronDownIcon v-if="isBillingCollapsed" />
              <AtomsIconsChevronUpIcon v-else />
            </span>
          </button>
          <div class="ms-5" v-if="!isBillingCollapsed">
            <NuxtLink
              href="/medicos/servicios"
              class="nav-link rounded-3 text-secondary"
              active-class="text-primary"
              ><small>Vauchers</small></NuxtLink
            >
            <NuxtLink
              href="/medicos/servicios/agregar"
              class="nav-link fs-6 rounded-3 text-secondary"
              active-class="text-primary"
              ><small>Proveedores</small></NuxtLink
            >
          </div>
        </li>
        <li class="nav-item w-100 mb-3">
